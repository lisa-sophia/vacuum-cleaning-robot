...
from vacuum_agent.liuvacuum import LIUVacuumEnvironment, ENV_CLEAN, ENV_DIRTY, ENV_WALL
from vacuum_agent.vacuumagent_BFS import MyVacuumAgent
from vacuum_agent.randomvacuumagent import RandomVacuumAgent
from vacuum_agent.reactivevacuumagent import ReactiveVacuumAgent
...
run = lambda: VacuumEnv().start_main_loop()
